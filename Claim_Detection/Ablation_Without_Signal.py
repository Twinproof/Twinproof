    ...
    for threshold in thresholds:
        ...
        for attack_name in ATTACKS:
            attack_scores = scores.loc[
                scores["Attack_Name"] == attack_name, "S_without_signal"
            ]
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Calculate the TwinProof ablation without cross-signal consistency."
    )
    parser.add_argument(
        "--results-root",
        type=Path,
